...
import {message} from "../";
const cards = [
  {title:"Discover a Challenge", desc:"Submit your problem description and solution proposal here", closed:false,shortDesc: "Something here goes here ... ", buttonHandleClick:() => {
    message.success("Action clicked");
  }},
  {title:"Register your Team", desc: "Learn about the challenges surrounding San Diego", closed:false,dueDate: new Date("01/25/2020, 11:59:00 PM"), submitted:true, buttonTitle:"SEARCH FOR TEAMMATES", buttonHandleClick:() => {
    message.success("HELLO");
  }},
  {title:"Submit a Preliminary Concept", desc:"Submit your problem description and solution proposal here", shortDesc: "Something here goes here ... ",closed:false, dueDate: new Date("12/12/2019, 11:59:00 PM"), submitted:false, buttonTitle:"SOMETHING"},
