...
const cards = [
  ...
  {title:"Register your Team", desc: "Learn about the challenges surrounding San Diego", closed:false,dueDate: new Date("01/25/2020, 11:59:00 PM"), submitted:true, buttonTitle:"SEARCH FOR TEAMMATES", active:true, buttonHandleClick:() => {
    message.success("HELLO");
  }},
  {title:"Submit a Preliminary Concept", desc:"Submit your problem description and solution proposal here", shortDesc: "Something here goes here ... ",active:false, closed:false, dueDate: new Date("12/12/2019, 11:59:00 PM"), submitted:false, buttonTitle:"SOMETHING"},
