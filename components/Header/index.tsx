...
const listItems = props.teamPictures ? props.teamPictures.map((pic: any) =>
  ...
  return (
    <div className={classes} >
      {props.back && <div className="go-back-bar" onClick={props.handleBackClick}>
      <svg width="39" height="30" viewBox="0 0 39 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="go-back-arrow">
